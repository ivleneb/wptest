...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'app.dataloader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\DataLoader A AppBundle\Service\DataLoader instance.
     */
    protected function getApp_DataloaderService()
    {
        return $this->services['app.dataloader'] = new \AppBundle\Service\DataLoader($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'DB2WAPOSAT', 'user' => 'root', 'password' => 'Waposat1_UNI', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4242dc1067d5bd80fb1c9dec548a1d201c6aca6b70600743290815393e680e60');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AppBundle\\Entity\\Users' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/dashboard');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/v2/dashboard');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('juan.basilio@waposat.com');
        $a->setPassword('juan.initec');
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b838d6a89d4f202b60768a4c09390fcea33edc31');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.our_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:Users', 'email', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'DB2WAPOSAT',
            'database_user' => 'root',
            'database_password' => 'Waposat1_UNI',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.zoho.com',
            'mailer_user' => 'juan.basilio@waposat.com',
            'mailer_password' => 'juan.initec',
            'mailer_encryption' => 'ssl',
            'mailer_port' => 465,
            'secret' => 'b838d6a89d4f202b60768a4c09390fcea33edc31',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'b838d6a89d4f202b60768a4c09390fcea33edc31',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'juan.basilio@waposat.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'juan.initec',
