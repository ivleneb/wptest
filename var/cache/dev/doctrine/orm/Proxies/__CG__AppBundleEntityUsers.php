...
class Users extends \AppBundle\Entity\Users implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'username', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'lastName', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'creationDate', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'roles', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'active', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'idUser'];
        }
