 ...
 */
class BlockType extends \AppBundle\Entity\BlockType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BlockType' . "\0" . 'blockType', '' . "\0" . 'AppBundle\\Entity\\BlockType' . "\0" . 'typeName', '' . "\0" . 'AppBundle\\Entity\\BlockType' . "\0" . 'idBlockType'];
        }
    ...
    public function setBlockType($blockType)
    {
        ...
        return parent::setBlockType($blockType);
    }
    ...
    public function getIdBlockType()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdBlockType();
        }
